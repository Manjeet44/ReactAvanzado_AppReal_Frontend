...
const EditarProducto = () => {
    ...
    //Conssultar para obtener el producto
    ...
    const schemaValidacion = Yup.object({
      ...
      precio: Yup.number().required('El precio es obligatorio').positive('No se aceptan numeros negativos').integer('Debe ser numero entero')
    });
    ...
    const actualizarInfoProducto = async valores => {
      ...
      try {
        ...
        Swal.fire(
          'Correcto',
          'El prodcuto se actualizo correctamente',
          'success'
        )
